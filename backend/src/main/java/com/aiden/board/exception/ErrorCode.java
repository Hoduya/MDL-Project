...
public enum ErrorCode {
    ...
    DUPLICATE_EMAIL(HttpStatus.CONFLICT, 102, "이미 가입된 이메일입니다"),
    DUPLICATE_USER_NAME(HttpStatus.CONFLICT, 103, "중복된 회원이름입니다"),
    LOGIN_FAILED(HttpStatus.BAD_REQUEST, 104, "아이디/비밀번호가 올바르지 않습니다"),
